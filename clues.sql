...
WHERE
    countrylanguages.language = 'Italian'
AND
    countrylanguages.percentage = 100;
...
WHERE
    countries.name = 'San Marino'
AND
    cities.name <> 'San Marino'
;
...
AND
    cities.name LIKE 'Serr%'
AND
    cities.name <> 'Serravalle'
;
